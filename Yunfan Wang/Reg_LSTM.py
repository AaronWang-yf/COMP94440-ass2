...
stopWords = ["a", "about", "above", "after", "again", "against", "ain", "all", "am", "an", "and", "any", "are", "aren",
             ...
             "can","couldn", "couldn't", "d", "did",  "do", "does", "doesn", "doesn't", "doing", "don", "down",
             ...
             "ma", "me", "mightn", "mightn't", "more", "most", "my", "myself", "needn", "now", "o", "of",
             "off", "on", "once", "only", "or", "other", "our", "ours", "ourselves", "out",
             "over", "own", "re", "s", "same", "shan", "she", "she's", "should","should've", "shouldn",  "so", "some", "such", "t", "than", "that",
...
class network(tnn.Module):
    ...
    def forward(self, input, length):
        ...
        dense_outputs = self.fc(output[0][:,-1,:])
